...
<body>
  ...
  <h1>SDO (Scheda di Dimissione Ospedaliera)</h1>
			...
			<div class="col-md-4 form-group">
				...
				<label class="custom-control custom-radio">
   				...
   				<div class="col-md-8 form-group">
					<label for="exampleFormControlSelect2">Seleziona la causa di dimissione.</label>
					<select class="form-control" id="exampleFormControlSelect2">
						<option>Dimesso a domicilio</option>
						<option>Trasferito ad altri ospedali per acuti</option>
						<option>Dimesso contro il parere dei sanitari</option>
						<option>Dimesso a domicilio con attivazione di assistenza a domicilio</option>
